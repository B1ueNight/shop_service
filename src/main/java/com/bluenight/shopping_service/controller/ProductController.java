...
public class ProductController {
    ...
    public String getProductlist(@RequestParam Integer category, @RequestParam @Nullable Integer offset, Model model) {
        ...
        // 최하위 카테고리(끝) = 가져온 child 카테고리가 0개라면 마지막 단계.
        ...
        // System.out.println(cate_seq_list);
    ...
    @GetMapping("/search")
    public String getProductSearch(@RequestParam String type, @RequestParam String keyword, @RequestParam @Nullable Integer offset, Model model){
