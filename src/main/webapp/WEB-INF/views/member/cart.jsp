            ...
            <div class="list_area">
                <c:if test="${list.size() == 0}">
                    <div class="empty_item">
                        ...
                        <a href="/">추천 상품 쇼핑하러 가기</a>
                    </div>
                </c:if>
                <c:forEach items="${list}" var="item">
                    <div class="list_item">
                        <div class="chk_area" value="">
                        ...
                        <div class="cnt_area">
                            <div class="count">
                                ...
                                <div class="count_btns">
                                    <button class="increase" id="count_up" data-price="${item.discounted_price}" data-origin="${item.pi_price}" 
                                    data-point="${item.saving_point}" data-stock="${item.pi_stock}" data-cart-seq="${item.scd_seq}" data-seq=${item.pi_seq}>
                                        <i class="fas fa-chevron-up"></i>
                                    </button>
                                    <button class="decrease" id="count_down" data-price="${item.discounted_price}" data-origin="${item.pi_price}"
                                    data-point="${item.saving_point}" data-stock="${item.pi_stock}" data-cart-seq="${item.scd_seq}" data-seq=${item.pi_seq}>
